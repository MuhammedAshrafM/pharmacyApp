...
public class AddSaleBillActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_sale_bill);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AddSaleBillActivity.this,R.layout.layout_spinner_item,R.id.textViewSpinnerItem,paymentWay);
        ...
        onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    ...
                    case R.id.barcode:
                        Intent intent = new Intent(AddSaleBillActivity.this,ScanActivity.class);
                    ...
                    case R.id.viewBill:
                        intent = new Intent(AddSaleBillActivity.this,PrintBillActivity.class);
    ...
    private void addPartBill(){
                ...
                if(response !=null){
                    if(!response.isEmpty()){
                        if(response.equals("Drug Not Available")){
                            Toast.makeText(AddSaleBillActivity.this,"Drug Not Available",Toast.LENGTH_LONG).show();
                        }
                        else if (response.equals("Select a lower count")){
                            Toast.makeText(AddSaleBillActivity.this,"Select a lower count",Toast.LENGTH_LONG).show();
                        }
                        else {
                            Toast.makeText(AddSaleBillActivity.this,"Added successfully",Toast.LENGTH_LONG).show();
                            try {
        ...
        Singleton.getSingleton(AddSaleBillActivity.this).setRequestQue(stringRequest);
    }
                ...
                if(!response.isEmpty()){
                    try {
                        ...
                        if(!jsonArray.equals(null)){
                            ...
                            PicassoClient.downloadimage(AddSaleBillActivity.this,strPictureName,circleImageView);
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
