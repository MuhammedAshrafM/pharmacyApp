...
public class SaleBillsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sale_bills);
    ...
    private void getJSON (){
        StringRequest stringRequest =new StringRequest(Request.Method.POST, Config.URL_PHARMACY, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if(!response.isEmpty()){
                    ...
                    adapterRecycler=new RecyclerViewAllBillsAdapter(SaleBillsActivity.this, billArrayList, "Sale");
        ...
        Singleton.getSingleton(SaleBillsActivity.this).setRequestQue(stringRequest);
    }
    ...
    private void deleteSelectedBills(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.URL_PHARMACY, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> map = new HashMap<>();
                map.put("function", "deleteSelectedPartSaleBill");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnSearchClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PopupMenu popupMenu=new PopupMenu(SaleBillsActivity.this,view);
                MenuInflater menuInflater=popupMenu.getMenuInflater();
                menuInflater.inflate(R.menu.type_search_menu,popupMenu.getMenu());
                SaleBillsActivity.PopupMenuEvent popupMenuEvent =new PopupMenuEvent(getApplicationContext());
    ...
    public class PopupMenuEvent implements android.support.v7.widget.PopupMenu.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            if(item.getItemId()==R.id.barcode){
                Intent intent = new Intent(SaleBillsActivity.this,ScanActivity.class);
