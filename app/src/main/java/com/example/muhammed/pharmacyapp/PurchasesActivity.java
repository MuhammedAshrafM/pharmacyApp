...
//                        .setAction("Action", null).show();
                Intent intent = new Intent(PurchasesActivity.this,AddPurchaseBillActivity.class);
    ...
    private void getJSON (){
        StringRequest stringRequest =new StringRequest(Request.Method.POST, Config.URL_PHARMACY, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if(!response.isEmpty()){
                    ...
                    adapterRecycler=new RecyclerViewBillAdapter(PurchasesActivity.this, billArrayList);
        ...
        Singleton.getSingleton(PurchasesActivity.this).setRequestQue(stringRequest);
    }
    ...
    private void deleteSelectedBills(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.URL_PHARMACY, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> map = new HashMap<>();
                map.put("function", "deleteSelectedPurchaseBills");
        ...
        switch (item.getItemId()){
            ...
            case R.id.edit:
                ...
                if(selectedBills.size() == 1) {
                    ...
                    Intent intent = new Intent(PurchasesActivity.this,PurchaseBillsActivity.class);
